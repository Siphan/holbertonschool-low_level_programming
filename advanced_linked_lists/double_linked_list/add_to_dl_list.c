 ...
 * The functions will take as parameters the List to modify, and the string (char *) to copy in the node
 * The functions must return 1 if it failed and 0 if it worked well.
 * The function strdup is used to copy str.
 */
